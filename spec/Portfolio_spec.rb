...
describe Portfolio do
  before(:all) do
    @apple_stocks = Stock.new("Apple", "AAPL", stock_test_prices("./test_data/AAPL.csv"))
    @google_stocks = Stock.new("Google", "GOOG", stock_test_prices("./test_data/GOOG.csv"))
    @netlix_stocks = Stock.new("Netflix", "NFLX", stock_test_prices("./test_data/NFLX.csv"))
  ...
  describe "#profit" do
    ...
    context "when the given dates aren't present in the stock data" do
      it "returns 0" do
        portfolio = Portfolio.new([@amazon_stocks, @google_stocks])
  ...
  describe "#value_at" do
    ...
    context "when given a date that isn't present in the stock data" do
      it "returns 0" do
        portfolio = Portfolio.new([@amazon_stocks, @google_stocks])
  ...
  describe "#annualized_return" do
    context "when given a set of two dates" do
      it "returns the annualized return of the portfolio between the two dates" do
        ...
        expect(annualized_return).to eq(0.47489746162044066)
      end
    end
  end
end
